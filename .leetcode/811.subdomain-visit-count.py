...
class Solution:
    def subdomainVisits(self, cpdomains: List[str]) -> List[str]:
        ...
        return [str(v) + ' ' + k for k, v in dd.items()]
...
if __name__ == '__main__':
    print('Example 1:')
    print('Input : ')
    print('cpdomains = ["9001 discuss.leetcode.com"]')
    print('Exception :')
    print('["9001 leetcode.com","9001 discuss.leetcode.com","9001 com"]')
    print('Output :')
    print(str(Solution().subdomainVisits(["9001 discuss.leetcode.com"])))
    print()

    print('Example 2:')
    print('Input : ')
    print(
        'cpdomains = ["900 google.mail.com", "50 yahoo.com", "1intel.mail.com", "5 wiki.org"]'
    )
    print('Exception :')
    print(
        '["901 mail.com","50 yahoo.com","900 google.mail.com","5 wiki.org","5org","1 intel.mail.com","951 com"]'
    )
    print('Output :')
    print(
        str(Solution().subdomainVisits([
