...
if __name__ == '__main__':
    ...
    print('3')
    print('Output :')
    print(str(Solution().carFleet(12, [10, 8, 0, 5, 3], [2, 4, 1, 1, 3])))
    print()
    ...
    print('1')
    print('Output :')
    print(str(Solution().carFleet(10, [3], [3])))
    print()

    print('Example 3:')
    print('Input : ')
    print('target = 100, position = [0,2,4], speed = [4,2,1]')
    print('Exception :')
    print('1')
    print('Output :')
    print(str(Solution().carFleet(100, [0, 2, 4], [4, 2, 1])))
    print()
