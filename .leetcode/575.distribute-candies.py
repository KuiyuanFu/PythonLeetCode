...
if __name__ == '__main__':
    print('Example 1:')
    print('Input : ')
    print('candyType = [1,1,2,2,3,3]')
    print('Exception :')
    print('3')
    print('Output :')
    print(str(Solution().distributeCandies([1, 1, 2, 2, 3, 3])))
    print()

    print('Example 2:')
    print('Input : ')
    print('candyType = [1,1,2,3]')
    print('Exception :')
    print('2')
    print('Output :')
    print(str(Solution().distributeCandies([1, 1, 2, 3])))
    print()

    print('Example 3:')
    print('Input : ')
    print('candyType = [6,6,6,6]')
    print('Exception :')
    print('1')
    print('Output :')
    print(str(Solution().distributeCandies([6, 6, 6, 6])))
    print()
