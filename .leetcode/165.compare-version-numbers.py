...
if __name__ == '__main__':
    ...
    print('Example 4:')
    print('Input : ')
    print('version1 = "1.0.1", version2 = "1"')
    print('Exception :')
    print('1')
    print('Output :')
    print(str(Solution().compareVersion("1.0.1", "1")))
    print()

    print('Example 5:')
    print('Input : ')
    print('version1 = "7.5.2.4", version2 = "7.5.3"')
    print('Exception :')
    print('-1')
    print('Output :')
    print(str(Solution().compareVersion("7.5.2.4", "7.5.3")))
    print()
